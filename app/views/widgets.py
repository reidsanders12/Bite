            ...
            ft.Stack(
                [
                    ...
                    ft.Container(
                        content=ft.Column(
                            [
                                ft.Text(f"{consumed}", size=18, weight=ft.FontWeight.BOLD),
                                ft.Text(f"/ {goal}{unit}", size=10, color=ft.Colors.ON_SURFACE_VARIANT),
                            ],
                            spacing=0,
    ...
    return ft.Container(
        content=ft.Row(
            [
                ...
                ft.Text(message, color=ft.Colors.ON_ERROR_CONTAINER, expand=True, size=13),
                ft.IconButton(
                    ft.Icons.CLOSE,
